...
<?php
// PHP Data Array (React ke pricingData ki tarah)
$pricing_list = [
    [
        "id" => 1,
        "planName" => "Starter",
        "className" => "Class 1-5",
        "image" => "assets/images/pricing1.png",
        "fees" => [
            ["label" => "4 Sessions per month", "price" => "$29"],
            ["label" => "30-minute sessions", "price" => "Included"]
        ],
        "feesPerHour" => "$15",
        "off" => "5% Savings"
    ],
    [
        ...
        "fees" => [
            ["label" => "12 Sessions per month", "price" => "$79"],
            ["label" => "60-minute sessions", "price" => "Included"]
        ],
        "feesPerHour" => "$12",
        "off" => "15% Savings"
    ],
    [
        ...
        "fees" => [
            ["label" => "Unlimited sessions", "price" => "$149"],
            ["label" => "60-minute sessions", "price" => "Included"]
        ],
        "feesPerHour" => "$10",
        "off" => "25% Savings"
...
<div class="pricing-page-wrapper py-5 position-relative" style="background-image: url('assets/images/price-bg.png'); background-size: contain; background-color: #F0F8FF;">
    ...
    <div class="container py-5 relative">
        ...
        <!-- Pricing Rows -->
        <?php foreach($pricing_list as $index => $plan): ?>
